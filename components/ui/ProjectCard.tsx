...
export function ProjectCard({
  ...
  return (
    <a 
      ...
      className="block p-6 bg-zinc-900/50 hover:bg-zinc-900/80 border border-zinc-800 transition-colors w-full h-[200px] flex flex-col"
    >
      {/* Hauptinhalt */}
      ...
      <div className="flex items-center gap-4">
        <span className="text-xs bg-zinc-800 px-2 py-1 rounded text-white">
          {language}
        </span>
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-xs text-zinc-300">{forks}</span>
        </div>
      </div>
    </a>
  );
